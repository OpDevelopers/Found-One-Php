...
if(isset($_POST["submit"])){
    ...
    $stmt = $conn->prepare("INSERT INTO `data` ( `tag`, `fandrTag`, `apartment`, `buildName`, `price`, `size`, `address`, `city`, `videolink`, `bed`, `bath`, `kitchen`, `d_one`, `d_two`, `d_three`, `d_four`, `mapLocation`, `date`, `product_id`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssdssssiiissssssi", $tag, $fandrTag, $apartment, $buildingName, $price, $size, $address, $city, $videoLink, $bed, $bath, $kitchen, $d_one, $d_two, $d_three, $d_four, $mapLocation, $date, $id);
